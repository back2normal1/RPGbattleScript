...
elixer = Item("Exiler", "elixer", "Fully restores HP/MP of one party member", 9999)
...
enemy2 = Person("Magus:",11200, 701, 525, 25, enemy_spells, enemy_items)
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            if spell.type == "white":
                ...
                print(bcolors.OKBLUE + "\n" + enemy.name.replace(" ", "") + " 's " + spell.name + "deals", str(magic_dmg), "points of damage to " + player[target].name.replace(" ", "") + bcolors.ENDC)
